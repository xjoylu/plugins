    ...
    E.config.emotions = {
        ...
        'weibo': {
            ...
            data: [
                ...
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/af/kl_org.gif',
                    value: '[可怜]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/f4/cj_org.gif',
                    value: '[吃惊]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/6e/shamea_org.gif',
                    value: '[害羞]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/c3/zy_org.gif',
                    value: '[挤眼]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/29/bz_org.gif',
                    value: '[闭嘴]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/71/bs2_org.gif',
                    value: '[鄙视]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/6d/lovea_org.gif',
                    value: '[爱你]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/9d/sada_org.gif',
                    value: '[泪]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/19/heia_org.gif',
                    value: '[偷笑]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/8f/qq_org.gif',
                    value: '[亲亲]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/b6/sb_org.gif',
                    value: '[生病]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/58/mb_org.gif',
                    value: '[太开心]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/17/ldln_org.gif',
                    value: '[懒得理你]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/98/yhh_org.gif',
                    value: '[右哼哼]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/6d/zhh_org.gif',
                    value: '[左哼哼]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/a6/x_org.gif',
                    value: '[[嘘]'
                },
                {
                ...
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/73/wq_org.gif',
                    value: '[委屈]'
                },
                {
                    icon: 'http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/9e/t_org.gif',
                    value: '[吐]'
                }
            ]
        }
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $widthInput = $('<input type="text" value="400" style="width:50px;text-align:center;"/>');
        var $heightInput = $('<input type="text" value="200" style="width:50px;text-align:center;"/>');
...
// 版权提示
_e(function (E, $) {
    E.info('本页面由开发者联盟提供，联系QQ：277177818');
});
