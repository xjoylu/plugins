...
if($method == 'GET') {
	...
	$input['footer_footer_left_start'] = form_textarea('footer_footer_left_start', $setting['footer_footer_left_start'], '100%', 100);
	$input['footer_footer_left_end'] = form_textarea('footer_footer_left_end', $setting['footer_footer_left_end'], '100%', 100);
	$input['footer_nav_before'] = form_textarea('footer_nav_before', $setting['footer_nav_before'], '100%', 100);
	$input['footer_nav_after'] = form_textarea('footer_nav_after', $setting['footer_nav_after'], '100%', 100);
	$input['header_body_start'] = form_textarea('header_body_start', $setting['header_body_start'], '100%', 100);
	$input['header_wrapper_start'] = form_textarea('header_wrapper_start', $setting['header_wrapper_start'], '100%', 100);
	$input['forum_mod_before'] = form_textarea('forum_mod_before', $setting['forum_mod_before'], '100%', 100);
	$input['index_page_before'] = form_textarea('index_page_before', $setting['index_page_before'], '100%', 100);
	$input['index_page_end'] = form_textarea('index_page_end', $setting['index_page_end'], '100%', 100);
	$input['index_start'] = form_textarea('index_start', $setting['index_start'], '100%', 100);
	$input['index_end'] = form_textarea('index_end', $setting['index_end'], '100%', 100);
	...
	$setting['forum_mod_before'] = param('forum_mod_before', '', FALSE);   //分类页-右侧上部
    $setting['index_page_before'] = param('index_page_before', '', FALSE);   //首页-分页上
    $setting['index_page_end'] = param('index_page_end', '', FALSE);   //首页-分页下
    $setting['index_start'] = param('index_start', '', FALSE);   //首页-顶部
    $setting['index_end'] = param('index_end', '', FALSE);   //首页-底部
