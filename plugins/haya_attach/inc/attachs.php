...
$n = haya_attach_file_count($cond);
$attachlist = attach_find($cond, array('create_date' => 1, 'aid' => 1), $page, $pagesize);
$pagination = pagination(url("attach-attachs-$srchtype-".urlencode($keyword).'-{page}'), $n, $page, $pagesize);
$pager = pager(url("attach-attachs-$srchtype-".urlencode($keyword).'-{page}'), $n, $page, $pagesize);
