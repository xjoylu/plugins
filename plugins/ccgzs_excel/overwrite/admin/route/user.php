...
if(empty($action) || $action == 'list') {
	...
	if($method == 'GET') {
		...
		$input['idnumber'] = form_text('idnumber','');  //【ccgzs_excel插件添加】
		...
		$idnumber = param('idnumber');  //【ccgzs_excel插件添加】
		...
		$r = user_create(array(
			'username'=>$username,
			'idnumber'=>$idnumber, //【ccgzs_excel插件添加】
	...
	if($method == 'GET') {
		...
		$input['idnumber'] = form_text('idnumber', $_user['idnumber']);
