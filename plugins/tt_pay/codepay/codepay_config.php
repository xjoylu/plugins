 ...
 */
$codepay_config['return_url'] = 'http://localhost/pay_notify.htm'; //自动生成跳转地址
...
$codepay_config['notify_url'] = 'http://localhost/pay_notify.htm'; //自动生成通知地址 优先级最高不传入则为系统设置里设置
