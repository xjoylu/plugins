 ...
 */
error_reporting(0);
include _include(APP_PATH.'plugin/ax_recharge/route/alipay.config.php');
...
/**************************请求参数**************************/
        ...
        //必填，不能修改
        //服务器异步通知页面路径
        $notify_url = $httpurl.url("notify_url");
        //需http://格式的完整路径，不能加?id=123这类自定义参数

        //页面跳转同步通知页面路径
        $return_url = $httpurl.url("return_url");
